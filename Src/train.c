...
void particles_init(ONE_PARTICLE_t *particles){
    ...
    for(uint8_t i=0;i<NUM_OF_PARTICLE;i++){
        ...
        particles[i].nowScores[JUMP_FOUR]=particles[i].nowScores[LIVE_THREE]+rand()%100000;
        particles[i].nowScores[FIGHT_FOUR]=particles[i].nowScores[LIVE_THREE]+rand()%100000;
        particles[i].nowScores[LIVE_FOUR]=particles[i].nowScores[LIVE_THREE]+rand()%100000;
        particles[i].nowScores[FIVE]=particles[i].nowScores[LIVE_FOUR]+rand()%1000000;
    }
    for(uint8_t i=0;i<NUM_OF_PARTICLE;i++){
